const podcasts = () => {
  ...
  <div class="podcast--main">
    <div class="podcast--container">
        <img class="podcast--image" src="/podcast-images/KNN-logo.jpg" alt="Kid Nation Nation">
  ...
  <div class="podcast--main">
    <div class="podcast--container">
        <img class="podcast--image" src="/podcast-images/LFTH_NS_LOGO.jpg" alt="Live Free, Twi Hard">
        <div class="podcast--details">

  ...
  $('#app').html(`
    ...
    <div class="bio--details">
      ...
      <ul class="bio--details-basic">
        ...
        <li>
          I have a passion for UX/UI Design and I often find myself spending
          hours tooling around with CSS.
        </li>
        <li>
          Sapien faucibus et molestie ac feugiat sed lectus. Interdum varius
          sit amet mattis vulputate.
        </li>
        <li>Lectus sit amet est placerat in egestas erat imperdiet.</li>
        <li>
          Nec sagittis aliquam malesuada bibendum arcu vitae elementum. Tortor
          dignissim convallis aenean et.
        </li>
        <li>
          Sit amet volutpat consequat mauris nunc. Vitae ultricies leo integer
          malesuada nunc vel.
        </li>
      </ul>
      ...
      <ul class="bio--details-education">
        ...
        <li>
          Nashville Software School · Full Stack Development Bootcamp · 2020 -
          2021
        </li>
      </ul>
